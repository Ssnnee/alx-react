...
describe("getAllNotificationsByUser", () => {
  it("should return the right data when userId is known", () => {
    const data = [
      {
...
describe("normalized", () => {
  it("should has a correct result array.", () => {
    const data = [
  ...
  it("should has a correct users entity.", () => {
    const data = {
      age: 25,
  ...
  it("should has a correct messages entity", () => {
    const data = {
  ...
  it("should has a correct notifications entity", () => {
    const data = {
